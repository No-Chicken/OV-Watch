...
uint8_t SPL_init()
{
	...
	SPL_WriteOneReg(SPL_TMP_CFG, 0x81);		// External Temperature 2x oversampling

	SPL_WriteOneReg(SPL_MEAS_CFG, 0x07);	// continuous temp and pressure measurement
...
void SPL_Wakeup()
{
	SPL_WriteOneReg(SPL_MEAS_CFG, 0x07);	// continuous temperature and pressure measurement
	//SPL_init();
}
