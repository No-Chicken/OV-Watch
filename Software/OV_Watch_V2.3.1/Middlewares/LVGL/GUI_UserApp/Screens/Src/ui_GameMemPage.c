...
static void Game_Mem_Init(void);
static void list_rand_number(uint8_t arry[], uint8_t max_count, uint8_t count);
static void updata_btnm(char * btnm_map[], uint8_t matrix[MATRIX_SIZE * MATRIX_SIZE + 1]);
...
///////////////////// FUNCTIONS ////////////////////
static void ui_event_GameMemBtnM_handler(lv_event_t * e)
{
