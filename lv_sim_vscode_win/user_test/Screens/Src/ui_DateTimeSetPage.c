...
void ui_DateSetPage_screen_init(void)
{
    ...
    lv_roller_set_selected(ui_YearSetRoller, 24-22, LV_ANIM_OFF);
    ...
    lv_roller_set_selected(ui_MonthSetRoller, 3-1, LV_ANIM_OFF);
    ...
    lv_roller_set_selected(ui_DaySetRoller, 26-1, LV_ANIM_OFF);
...
void ui_TimeSetPage_screen_init(void)
{
    ...
    lv_roller_set_selected(ui_HourSetRoller, 11, LV_ANIM_OFF);
    ...
    lv_roller_set_selected(ui_MinSetRoller, 59, LV_ANIM_OFF);
    ...
    lv_roller_set_selected(ui_SecSetRoller, 55, LV_ANIM_OFF);
