...
lv_meter_indicator_t * ui_Compass_indic;
...
uint16_t ui_CompassDirValue = 105;
int16_t ui_EnvAltitudeValue = 20;
...
void ui_CompassPage_screen_init(void)
{
    ...
    ui_Compass_indic = lv_meter_add_needle_img(ui_CompassMeter,scale_360,&ui_img_compass_needle_png,10,85);
    lv_meter_set_indicator_value(ui_CompassMeter,ui_Compass_indic,ui_CompassDirValue);
